...
namespace Repository
{
    public class OwnerRepository : RepositoryBase<Owner>, IOwnerRepository
    {
        ...
        public ExpandoObject GetFilteredOwnerById(Guid ownerId, string fields)
        {
        ...
        public List<Owner> GetOwnersUsingPagination(int pageIndex, int pageSize)
        {
            var numberOfItemsToSkip = pageIndex * pageSize;
            var owners = FindAll().Skip(numberOfItemsToSkip).Take(pageSize).ToList();
